...
public class LevelGenerator : MonoBehaviour
{
    ...
    private List<GameObject> generationOutlines = new List<GameObject>();
    ...
    void Start()
    {
        ...
        foreach (GameObject outline in generationOutlines)
        {
    ...
    public void CreateRoomOutline(Vector3 roomPosition)
    {
        ...
        switch (directionCount)
        {
            ...
            case 1:
                ...
                if (roomAbove)
                {
                   generationOutlines.Add(Instantiate(rooms.singleUp, roomPosition, transform.rotation));
                }
                if (roomBelow)
                {
                    generationOutlines.Add(Instantiate(rooms.singleDown, roomPosition, transform.rotation));
                }
                if (roomLeft)
                {
                    generationOutlines.Add(Instantiate(rooms.singleLeft, roomPosition, transform.rotation));
                }
                if (roomRight)
                {
                    generationOutlines.Add(Instantiate(rooms.singleRight, roomPosition, transform.rotation));
                }
            ...
            case 2:
                ...
                {
                    generationOutlines.Add(Instantiate(rooms.doubleUpDown, roomPosition, transform.rotation));
                }

                if(roomLeft && roomRight)
                {
                    generationOutlines.Add(Instantiate(rooms.doubleLeftRight, roomPosition, transform.rotation));
                }
                if(roomAbove && roomRight)
                {
                    generationOutlines.Add(Instantiate(rooms.doubleRightUp, roomPosition, transform.rotation));
                }
                if(roomRight && roomBelow)
                {
                    generationOutlines.Add(Instantiate(rooms.doubleRightdown, roomPosition, transform.rotation));
                }
                if(roomBelow && roomLeft)
                {
                    generationOutlines.Add(Instantiate(rooms.doubleLeftDown, roomPosition, transform.rotation));
                }
                if(roomAbove && roomLeft)
                {
                    generationOutlines.Add(Instantiate(rooms.doubleLeftUp, roomPosition, transform.rotation));
                }
                break;
            ...
            case 3:
                ...
                {
                    generationOutlines.Add(Instantiate(rooms.tripleUpRightDown, roomPosition, transform.rotation));
                }
                if(roomRight && roomBelow && roomLeft)
                {
                    generationOutlines.Add(Instantiate(rooms.tripleRightDownLeft, roomPosition, transform.rotation));
                }
                if(roomBelow && roomLeft && roomAbove)
                {
                    generationOutlines.Add(Instantiate(rooms.tripleDownLeftUp, roomPosition, transform.rotation));
                }
                if(roomLeft && roomAbove && roomRight)
                {
                    generationOutlines.Add(Instantiate(rooms.tripleLeftUpRight, roomPosition, transform.rotation));
                }
            ...
            case 4:
                ...
                {
                    generationOutlines.Add(Instantiate(rooms.fourway, roomPosition, transform.rotation));
                }
...
public class RoomPrefabs
{
    public GameObject singleUp, singleDown, singleLeft, singleRight,
        doubleLeftRight, doubleUpDown, doubleRightUp, doubleRightdown, doubleLeftUp, doubleLeftDown,
