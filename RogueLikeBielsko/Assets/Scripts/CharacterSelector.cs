...
public class CharacterSelector : MonoBehaviour
{
    ...
    public PlayerControler playerToSpawn;
    ...
    void Update()
    {
        if (canSelect)
        {
            if (Input.GetKeyDown(KeyCode.E))
            {
                ...
                PlayerControler newPlayer = Instantiate(playerToSpawn, playerPos, playerToSpawn.transform.rotation);
                PlayerControler.instance = newPlayer;
