...
public class EnemyController : MonoBehaviour
{
    ...
    public float rangeToChancePlayer;
    ...
    void Update()
    {
        if(theBody.isVisible && PlayerControler.instance.gameObject.activeInHierarchy)
        {
            ...
            if (Vector3.Distance(transform.position, PlayerControler.instance.transform.position) < rangeToChancePlayer && shouldChasePlayer)
            {
            ...
            if (shouldRunAway && Vector3.Distance(transform.position, PlayerControler.instance.transform.position) < runawayRange)
            {
                moveDirection = transform.position - PlayerControler.instance.transform.position;
            }
